...
Browser support is defined in the `eline/browserslist` file that is used for autoprefixing CSS.
...
|run psql                           |`make psql`                        |`docker-compose exec postgres psql --user eline --dbname eline` |


## Running commands on the server

    docker-compose -f docker-compose.production.yml run --rm --name eline_tmp django python manage.py <command>
