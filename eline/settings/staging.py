...
ALLOWED_HOSTS = ['eline.test.accounts.ms45.edu.ru']

# Static site url, used when we need absolute url but lack request object, e.g. in email sending.
SITE_URL = 'https://eline.test.accounts.ms45.edu.ru'
...
LOGGING['handlers'] = {
    'info_log': {
        ...
        'filename': '/var/log/eline/info.log',
        'formatter': 'default',
    },
    'error_log': {
        'level': 'ERROR',
        'class': 'logging.handlers.WatchedFileHandler',
        'filename': '/var/log/eline/error.log',
        'formatter': 'default',
    },
    'sentry': {
        'level': 'ERROR',
