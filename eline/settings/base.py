...
ADMINS = (
    ('Admins', 'admin@ms45.edu.ru'),
)
MANAGERS = ADMINS
EMAIL_SUBJECT_PREFIX = '[User Management System] '  # subject prefix for managers & admins

SESSION_COOKIE_NAME = 'eline_ssid'
...
ROOT_URLCONF = 'eline.urls'

WSGI_APPLICATION = 'eline.wsgi.application'
...
# Email config
DEFAULT_FROM_EMAIL = "User Management System <info@accounts.ms45.edu.ru>"
SERVER_EMAIL = "User Management System server <server@accounts.ms45.edu.ru>"
